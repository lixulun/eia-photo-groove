	...
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$html$Html$Attributes$class('larger'),
...
var $author$project$PhotoGroove$main = $elm$browser$Browser$sandbox(
	{init: $author$project$PhotoGroove$initModel, update: $author$project$PhotoGroove$update, view: $author$project$PhotoGroove$view});
